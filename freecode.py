...
def triangle(sidelength, color):
	...
	for i in range (3):
		...
		right(120)
triangle(50, "yellow")
sidelength1=int(input("How long are the sides?"))
color1=input("What color?")
sides1=int(input("How many sides?"))
def polygon(sidelength, color, sides):
	pendown()
	for i in range (sides):
		pencolor(color)
		forward(sidelength)
		right(360/sides)
polygon(sidelength1, color1, sides1)